                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="footer_payment text-right">
                            <a href="#"><img src="{{url('/')}}/frontend-assets/img/icon/payment.png" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="modal_tab">  
                                    ...
                                    <div class="modal_tab_button">    
                                        <ul class="nav product_navactive owl-carousel" role="tablist">
                                            ...
                                            <li>
                                                 <a class="nav-link" data-toggle="tab" href="#tab2" role="tab" aria-controls="tab2" aria-selected="false"><img src="{{url('/')}}/frontend-assets/img/product/product2.jpg" alt=""></a>
                                            </li>
                                            <li>
                                               <a class="nav-link button_three" data-toggle="tab" href="#tab3" role="tab" aria-controls="tab3" aria-selected="false"><img src="{{url('/')}}/frontend-assets/img/product/product3.jpg" alt=""></a>
                                            </li>
                                            <li>
                                               <a class="nav-link" data-toggle="tab" href="#tab4" role="tab" aria-controls="tab4" aria-selected="false"><img src="{{url('/')}}/frontend-assets/img/product/product5.jpg" alt=""></a>
                                            </li>
